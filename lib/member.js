...
// this does allow indefinite recursion with the final prompt. The Team object gets sent via a callback to the "new member" function.
// this also finalizes the node interactions, pushing out HTML if the user doesn't want to add more team members.
